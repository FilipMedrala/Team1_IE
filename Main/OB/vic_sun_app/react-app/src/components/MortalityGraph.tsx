...
import '../App.css';
import mortalitydata from '../data/cancer_mortality.json';
import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer } from 'recharts';
import { Typography } from '@mui/material';

const MortalityGraph: React.FC = () => {
  ...
  const filteredData = selectedAgeCategories.length > 0 ? mortalitydata.filter(item => selectedAgeCategories.includes(item["Age Category"])) : mortalitydata;

  return (
    <div className="MortalityGraph">
      <Typography variant="h4" gutterBottom className="graph-title">Skin Cancer Mortality from 1971 to 2023</Typography>
      ...
      <ResponsiveContainer width="90%" height={400}>
        ...
        >
          ...
          <XAxis type="number" dataKey="Year" domain={[1971, 2023]} />
          <YAxis />
          <Tooltip />
