...
const SunscreenDosageCalculator: React.FC = () => {
  ...
  return (
    <div className="infoBox" style={{ marginLeft: '20px' }}> {/* Added left margin */}
      <form onSubmit={handleSubmit} style={{ lineHeight: '1.5' }}>
        <div>
        {/* <h2 className='text-start p-3'>Calculate your sunscreen usage</h2>c */}
          <label>
            Height in cm:
            <input
              type="number"
...
The UV level is affected by a number of factors including the time of day, time of year, cloud cover, altitude, location and surrounding surfaces</p>
      ...
      {/* //const colors=['#9af5b2','#feec98','#ffd799','#ffaead','#d4adfe'] */}
        ...
        <h3 className='text-start px-3 box1 color1'>1-2 Low</h3>
        ...
        <h3 className='text-start px-3 box1 color2'>3 - 5 Moderate</h3>
        <p className="text-start px-3">
          <b>Some Protect is Required</b> <br></br>Wear sun-protective clothing, a broad-brimmed hat and sunglasses. Apply high SPF sunscreen to any unprotected skin. .
        </p>
        <h3 className='text-start px-3 box1 color3'>6 - 7 High</h3>
        <p className="text-start px-3">
          <b>Protect Essntial</b> <br></br>Wear sun-protective clothing, a broad-brimmed hat and sunglasses. Apply high SPF sunscreen to any unprotected skin.
        </p>
        <h3 className='text-start px-3 box1 color4'>8 - 10 Very High</h3>
        <p className="text-start px-3">
          <b>Extra Protection Required</b> <br></br>Wear sun-protective clothing, a broad-brimmed hat and sunglasses. Apply high SPF sunscreen to any unprotected skin. Seek shade.
        </p>
        <h3 className='text-start px-3 box1 color5'>11+ Extreme</h3>
        <p className="text-start px-3">
...
During the sun protection times, protect skin and eyes by using covering clothing, high SPF sunscreen, a broad-brimmed hat, shade and sunglasses.
      ...
      <div className='row'>
        <div className='col-2'>
        <img src={shirt} alt=""  width='90%' className='img-fluid p-3'/>
        </div>
        ...
        <div className='col-2'>
          <img src={suncream} alt=""  width='90%' className='img-fluid p-3'/>
        </div>
        <div className='col-10'>
        ...
        <div className='col-2'>
          <img src={hat} alt=""  width='90%' className='img-fluid p-3'/>
        </div>
        <div className='col-10'>
        ...
        <div className='col-2'>
          <img src={umbrella} alt=""  width='90%' className='img-fluid p-3'/>
        </div>
        <div className='col-10'>
        ...
        <div className='col-2'>
          <img src={sunglasses} alt=""  width='90%' className='img-fluid p-3'/>
        </div>
        <div className='col-10'>
